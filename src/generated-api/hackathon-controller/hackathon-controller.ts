...
export const createHackathon = (
    hackathonRequest: HackathonRequest, options?: AxiosRequestConfig
...
export const getCreateHackathonMutationOptions = <TError = AxiosError<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createHackathon>>, TError,{data: HackathonRequest}, TContext>, axios?: AxiosRequestConfig}
): UseMutationOptions<Awaited<ReturnType<typeof createHackathon>>, TError,{data: HackathonRequest}, TContext> => {
...
const {mutation: mutationOptions, axios: axiosOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createHackathon>>, {data: HackathonRequest}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useCreateHackathon = <TError = AxiosError<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createHackathon>>, TError,{data: HackathonRequest}, TContext>, axios?: AxiosRequestConfig}
...
export const getGetMyHackathonsQueryOptions = <TData = Awaited<ReturnType<typeof getMyHackathons>>, TError = AxiosError<unknown>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getMyHackathons>>, TError, TData>>, axios?: AxiosRequestConfig}
) => {
...
const {query: queryOptions, axios: axiosOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetMyHackathonsQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getMyHackathons>>> = ({ signal }) => getMyHackathons({ signal, ...axiosOptions });

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMyHackathons>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetMyHackathonsQueryResult = NonNullable<Awaited<ReturnType<typeof getMyHackathons>>>
export type GetMyHackathonsQueryError = AxiosError<unknown>


export function useGetMyHackathons<TData = Awaited<ReturnType<typeof getMyHackathons>>, TError = AxiosError<unknown>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getMyHackathons>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetMyHackathons<TData = Awaited<ReturnType<typeof getMyHackathons>>, TError = AxiosError<unknown>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getMyHackathons>>, TError, TData>>, axios?: AxiosRequestConfig}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
